...
- (instancetype)initWithFrame:(CGRect)frame scrollView:(UIScrollView *)scrollView{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        if (CGRectIsEmpty(frame)) {
            self.frame = CGRectMake(kScreenWidth - TOTOPBUTTON_WH - EDGE_MARGIN, kScreenHeight - TOTOPBUTTON_WH - EDGE_MARGIN-64, TOTOPBUTTON_WH, TOTOPBUTTON_WH);
        }
