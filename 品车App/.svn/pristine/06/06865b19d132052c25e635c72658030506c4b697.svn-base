...
NSString *const MJRefreshAutoFooterIdleText = nil;
NSString *const MJRefreshAutoFooterRefreshingText =nil;
NSString *const MJRefreshAutoFooterNoMoreDataText = nil;
