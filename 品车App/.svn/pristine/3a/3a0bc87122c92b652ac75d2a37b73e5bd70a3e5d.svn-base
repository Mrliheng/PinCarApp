...
-(void)btnClick:(UIButton *)btn{
    ...
    switch (btn.tag - baseTag) {
        ...
        case 2:
        {
            ...
            listView.fildId = @2;
            listView.navcTitle = @"爱车世界";
            [tabBar.selectedViewController pushViewController:listView animated:YES];
            
            InvitationViewController *invitation = [[InvitationViewController alloc]init];
            invitation.fildId = @2;
            [tabBar.selectedViewController pushViewController:invitation animated:YES];
